package com.VandalayIndustries.employeedirectory;
...
public class EmployeeDetails extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Cursor cursor = db.rawQuery("SELECT emp._id, emp.firstName, emp.lastName, emp.title, emp.officePhone, emp.cellPhone, emp.email, emp.managerId, mgr.firstName managerFirstName, mgr.lastName managerLastName, emp.picture FROM employee emp LEFT OUTER JOIN employee mgr ON emp.managerId = mgr._id WHERE emp._id = ?", 
